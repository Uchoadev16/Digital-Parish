...
<html lang="pt-br">
        ...
        <div class="w-full max-w-md relative">
          ...
          <div id="form1" class="form-container">
            <div class="bg-white rounded-2xl p-8 golden-glow border border-accent/10">
              ...
              <form id="formEmailCPF" class="space-y-5">
                <div class="space-y-2">
          ...
          <div id="form2" class="form-container hidden">
            <div class="bg-white rounded-2xl p-8 golden-glow border border-accent/10">
              ...
              <form id="formSenhas" class="space-y-5">
                <input type="hidden" id="emailHidden" name="email">
                <input type="hidden" id="cpfHidden" name="cpf">
  ...
  <script>
    ...
    document.getElementById('formEmailCPF').addEventListener('submit', function(e) {
      e.preventDefault();
