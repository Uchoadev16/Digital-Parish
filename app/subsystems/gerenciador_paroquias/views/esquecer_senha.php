        ...
        <div class="w-full max-w-md">
          ...
          <div class="bg-white rounded-2xl p-8 golden-glow border border-accent/10">
            ...
            <div id="stepEmail">
              ...
              <form id="formEmail" class="space-y-5">
                <div class="space-y-2">
            ...
            <div id="stepCode" class="hidden">
              ...
              <form id="formCode" class="space-y-6">
                <div class="flex justify-center gap-3">
                  <input type="text" maxlength="1" class="code-input w-12 h-14 text-center text-2xl font-semibold rounded-xl border-2 border-gray-200 focus:outline-none text-primary bg-secondary/30" data-index="0">
                  <input type="text" maxlength="1" class="code-input w-12 h-14 text-center text-2xl font-semibold rounded-xl border-2 border-gray-200 focus:outline-none text-primary bg-secondary/30" data-index="1">
                  <input type="text" maxlength="1" class="code-input w-12 h-14 text-center text-2xl font-semibold rounded-xl border-2 border-gray-200 focus:outline-none text-primary bg-secondary/30" data-index="2">
                  <input type="text" maxlength="1" class="code-input w-12 h-14 text-center text-2xl font-semibold rounded-xl border-2 border-gray-200 focus:outline-none text-primary bg-secondary/30" data-index="3">
                  <input type="text" maxlength="1" class="code-input w-12 h-14 text-center text-2xl font-semibold rounded-xl border-2 border-gray-200 focus:outline-none text-primary bg-secondary/30" data-index="4">
                  <input type="text" maxlength="1" class="code-input w-12 h-14 text-center text-2xl font-semibold rounded-xl border-2 border-gray-200 focus:outline-none text-primary bg-secondary/30" data-index="5">
                </div>
                ...
                <p class="text-center text-sm text-primary/50">
                  ...
                  <button type="button" id="resendCode" class="text-accent-dark hover:text-accent font-medium transition-colors">
                    Reenviar
                  </button>
                </p>
              </form>
